...
async function seed() {
    ...
    await db.insert(transactions).values([
        {userId: admin.id, title: 'Makan', amount: 15000, date: new Date('2024-05-01'), category: 'pemasukan'},
        {userId: admin.id, title: 'Transportasi', amount: 20000, date: new Date('2024-05-02'), category: 'pengeluaran'},
    ]);
